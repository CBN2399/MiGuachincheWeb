...
insert into restaurante(zonaId,Nombre,Rest_Url,telefono,valoracion,Id_tipo,Descripcion) values(3,'Paraiso','Paraiso','922111333',2,1,'Se puede observar un restaurante donde en la entrada mesa y sillas de madera, y entre medias una entrada de madera rústica');
